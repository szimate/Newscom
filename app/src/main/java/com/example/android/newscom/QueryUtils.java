...
public class QueryUtils {
    ...
    /**
     * Query the Google Books API dataset and return a list of {@link News} objects.
     */
    ...
    private static List<News> extractFeatureFromJSON(String responseJSON) {
        ...
        try {
            ...
            // For each news item in the resultsArray, create an {@link News} object
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // Create a new {@link News} object with the title, authors, and thumbnail,
                // from the JSON response.
                News newsItem = new News(title, section, url, author, dateString);
